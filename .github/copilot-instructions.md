...
- **`modules/`**: Flake-parts modules auto-imported via import-tree
  ...
  - **`aspects/`**: Den aspects organized by category
    ...
    - **`my/`**: Reusable aspects in the `my` namespace (~43 aspects)
      ...
      - Services: nginx.nix, minecraft-servers.nix, paperless.nix, plex.nix, prowlarr.nix, qbittorrent.nix, radarr.nix,
...
- **Services**: minecraft-servers, plex, prowlarr, qbittorrent, radarr, sonarr, unpackerr, autobrr, cross-seed,
