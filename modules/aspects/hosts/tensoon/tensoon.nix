{ inputs, my, ... }: {
  ...
  den.aspects.tensoon = {
    ...
    nixos = {
      ...
      # tensoon's /etc/ssh/ssh_host_ed25519_key.pub, generated by hand into /persist/etc/ssh/ during
      # install. `agenix generate -a && agenix rekey -a` (YubiKey) rekeys against this and writes
      # secrets/rekeyed/tensoon* + secrets/rekeyed/tensoon-home-oscar*.
